...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'frontend', 'build'),  # Points to React's build directory
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'frontend', 'build'),            # Root-level static files (manifest.json, favicon.ico, etc.)
]
